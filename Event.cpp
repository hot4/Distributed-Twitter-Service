...
/**
  ...
  */
Event::Event(std::string type, std::string operation, time_t rawTimeStamp) : type(type), operation(operation), rawTimeStamp(rawTimeStamp) {}
...
/**
  ...
  * @retunrs A new Event object
  */
Event::Event(std::string type, std::string operation, std::string recipient, std::string message, time_t rawTimeStamp) : type(type), operation(operation), recipient(recipient), message(message), rawTimeStamp(rawTimeStamp) {}